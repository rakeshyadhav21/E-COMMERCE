...
const NewArrivals = () =>{
    ...
    const handleMouseMove = (e) => {
        ...
        const walk = x - startX;
        scrollLeft.current.scrollLeft =  scrollLeft - walk;
    };
    ...
    return <section className="py-16 px-4 lg:px-0">
        <div className="container mx-auto text-center mb-10 relative">
            ...
            <p className="text-lg text-gray-600 mb-8">
                ...
                keep your wardroube on the cutting edge of fashion.
            </p>
        ...
        >
            {newArrivals.map((product) => (
                <div
                key={product._id}
                className="min-w-[300px] sm:min-w-[350px] lg:min-w-[400px] relative rounded-lg overflow-hidden shadow-md"
                >
                {/* Image */}
                <img
